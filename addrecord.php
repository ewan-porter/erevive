...
<head>
    ...
    <title>eRevive - Add a record</title>
                ...
                <!-- add a record form -->
                    <form action="addrecordprocess.php" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="mb-4 col-md-12 add-input">
                            ...
                            <input  type="number" step=".01" class="form-control add-form" id="cost" name="cost" required>
                        </div>

                        <div class="mb-4 col-md-12 add-input">
                            <label for="description" class="form-label mb-1">Description</label>
                            <textarea class="form-control add-form" id="description" name="description" rows="4" required></textarea>
                        </div>
                        ...
                        <div class="mt-3 col-md-12 d-flex justify-content-center">
                            <div class="px-2">
                                <a href="admin.php"><input class="btn btn-primary btn-lg cancelBtn hvr-grow" value="Cancel"
                                    id="cancel"></a>
                            </div>
                            <div class="px-2">
